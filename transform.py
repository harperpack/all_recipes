    ...
    if selection:
        if isinstance(selection, list):
            ...
            if selection == 'h':
                ...
                recipe = categorize_veg(recipe)
                recipe = transform_veg(recipe)
            elif selection == 'vgn':
                categorize_veg(recipe, vgn = True)
                recipe = transform_veg(recipe, vgn = True)
            elif selection == 'm':
                recipe = categorize_ingredients(recipe, cat = 'm')
                recipe = transform_meatier(recipe)
            elif selection == 'a':
                recipe = categorize_ingredients(recipe, cat = 'a')
                recipe = transform_cost(recipe)
            elif selection == 'e':
                recipe = categorize_ingredients(recipe, cat = 'e')
                recipe = transform_cost(recipe, more = True)
            elif selection == 'b':
                recipe = categorize_ingredients(recipe, cat = 'b')
                recipe = transform_spice(recipe)
            elif selection == 's':
                recipe = categorize_ingredients(recipe, cat = 's')
